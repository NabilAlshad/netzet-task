...
const HeroSection: React.FC = ({}) => {
	return (
		<div className='flex flex-col lg:flex-row w-full h-[400px] lg:relative static mt-3'>
			...
			<div className='w-full lg:w-[55%] z-9999'>
				<h3
				...
				<div className='flex flex-col-reverse lg:flex lg:flex-col lg:items-start items-center'>
					<div>
						<Button className='w-[316px] flex justify-center items-center gap-3 shadow-[2px_2px_10px_0px_#00E7F9] mt-5 text-[20px] font-bold bg-[#FC004E] p-3 rounded-2xl '>
							Get Started
							<span>
								<Arrow />
							</span>
						</Button>
						<p className='text-[12px] font-normal text-[#FFFFFF] text-center mt-2'>
					...
					<div className='px-5 lg:px-0'>
						...
						<p className='text-[10px] text-center lg:text-left text-[#ABABAB] font-[500]'>
							{data?.FooterText}
						</p>
					</div>
				</div>
